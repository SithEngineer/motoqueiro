...
class Gravity @Inject constructor(private val sensorManager: SensorManager) :
  ...
  override fun listen(): Observable<RelativeCoordinates> {
    return Observable.create { subscriber ->
      if (!subscriber.isDisposed) {
        ...
        subscriber.setCancellable { sensorManager.unregisterListener(listener, gravitySensor) }
